  ...
  <div class="container">
    ...
    <form id="form-create">
      <div class="form-group my-2">
        ...
        <input type="text" name="title" id="title" placeholder="Membuat Sendok dari Kardus" class="form-control" value="<?= $data['title'] ?>">
      </div>
      <div class="form-group my-2">
...
<script>
  $(document).ready(() => {
    ...
    $('#form-create').on('submit', (e) => {
      ...
      $.ajax({
        url: "<?= BASE_URL ?>index.php?p=article/aupdate",
        method: "POST",
        data: {
          id: <?= $data['id'] ?>,
          title: $('#title').val(),
